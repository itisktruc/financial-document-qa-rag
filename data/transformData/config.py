...
TASKS = [
    {
        ...
        "urls": [
            "https://www.vinamilk.com.vn/investor/reports/financial?year={year}&quarter={quarter}"
            for year in range(2024, 2027)
            for quarter in range(1, 5)
        ]
        + ["https://www.vinamilk.com.vn/investor/reports/annual"]
        + [
            "https://www.vinamilk.com.vn/investor/reports/governance?year={year}"
            for year in range(2024, 2027)
        ],
    ...
    },
    {
        ...
        "urls": [
            "https://www.hoaphat.com.vn/quan-he-co-dong/bao-cao-thuong-nien?page={page}"
            for page in range(1, 3)
        ]
        + [
            "https://www.hoaphat.com.vn/quan-he-co-dong/bao-cao-tai-chinh?page={page}"
            for page in range(1, 3)
        ]
        + ["https://www.hoaphat.com.vn/quan-he-co-dong/cao-bach"],
        "click_years": [],
        "files_to_download": [],
    },
    {
        "company": "TheGioiDiDong",
        "urls": ["https://mwg.vn/cong-bo-thong-tin"],
